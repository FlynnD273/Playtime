...
import com.flynnd273.playtime.Database.*
import com.flynnd273.playtime.Utils.*
...
class Library(val scope: CoroutineScope) {
	...
	val allArtists = _artists.asStateFlow()
...
//            coroutineScope { albumArtCache.list().map { async { it.delete() } }.awaitAll() }
			...
			val filesChannel = scope.produce(Dispatchers.IO, capacity = 512) {
